...
//        });
	 ...
	 *                                  extension) is found the images folder
	 */
...
//	}
	...
	/**
	 * Force scheduling of a new window paint (this may take a while, it does not
	 * necessarily happen immediately after this instruction is issued)
	 */
	public void update() {
		frame.repaint();
	}
...
//		return new Dimension(N_SQUARES_WIDTH, N_SQUARES_HEIGHT);
	...
	public void setSize(int i, int j) {
		...
		if (INSTANCE != null) {
			...
			INSTANCE.panel.setPreferredSize(
					new Dimension(n_squares_width * INSTANCE.SQUARE_SIZE, n_squares_height * INSTANCE.SQUARE_SIZE));
			INSTANCE.info
					.setPreferredSize(new Dimension(n_squares_width * INSTANCE.SQUARE_SIZE, INSTANCE.LABEL_HEIGHT));
	...
	public synchronized void setWindowClosed(boolean windowClosed) { // Added 25-out-2022
