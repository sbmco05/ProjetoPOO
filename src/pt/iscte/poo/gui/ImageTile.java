...
public interface ImageTile {
	...
	/**
	 * The name of the image. Must correspond to the name of an image file in the
	 * "images" folder otherwise it will trigger one of the following exceptions:
	...
	/**
	 * Getter for the level of the image, higher levels are displed on top of lower
	 * ones (level 0 will be the first images to be displayed, the higher the level
	 * the later in the rendering the image will be added).
	 * 
	 * @return int.
	 */
	int getLayer();
